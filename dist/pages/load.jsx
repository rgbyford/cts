...
class FileInput extends React.Component {
    ...
    render() {
        ...
        {this.state.response
            ...
            : <p>Loading {this.state.timeCounter}</p>}</div>
      </form>);
    }
}
class LoadPage extends React.Component {
    ...
    render() {
      ...
      `}</style>
        ...
        <form>
         <label>Empty the database before loading: <input style={buttonStyle} name="bClearDB" type="checkbox" checked={this.state.bClearDB} onChange={this.handleInputChange}/>
         </label>
         <br /><br />
         <label>Rebuild the categories file: <input style={buttonStyle} name="bClearCats" type="checkbox" checked={this.state.bClearCats} onChange={this.handleInputChange}/>
         </label>
         <br /><br />
        </form>
