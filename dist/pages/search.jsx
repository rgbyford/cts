...
class CSRWithData extends React.Component {
    ...
    csr(state) {
        ...
        return (<div style={{ textAlign: 'center', margin: '0 20px' }}>
      {Header()}
      <h2>Search page</h2>
      <strong>
        {aoSearch.map((oSrch, index1) => <div key={index1}>
          ...
          {oSrch.bComplete ? '' :
            <div><select size={10} multiple={oSrch.bAllowMult ? true : false} onChange={(e) => this.catAddSelect(e, index1)}>
